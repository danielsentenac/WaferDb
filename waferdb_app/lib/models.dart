...
class StatusHistoryEntry {
  ...
  bool get isAutoGenerated => sourceActivityId != null;
  ...
  factory StatusHistoryEntry.fromJson(Map<String, dynamic> json) {
    return StatusHistoryEntry(
      ...
      notes: _asString(json['notes']),
      sourceActivityId: _asInt(json['sourceActivityId']),
    );
  }
}
...
class ActivityEntry {
  ...
  factory ActivityEntry.fromJson(Map<String, dynamic> json) {
    return ActivityEntry(
      ...
      exposureQuantity: _asDouble(json['exposureQuantity']),
      exposureUnit: _asString(json['exposureUnit']),
      statusCode: _asString(json['statusCode']),
      statusLabel: _asString(json['statusLabel']),
