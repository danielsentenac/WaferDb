                ...
                children: detail.statusHistory
                    .map(
                      (entry) => _StatusHistoryCard(
                        entry: entry,
                        onEdit: entry.isAutoGenerated ? null : () => _editStatus(detail.wafer.waferId, entry),
                        onDelete: entry.isAutoGenerated ? null : () => _deleteStatus(detail.wafer.waferId, entry),
                      ),
                    )
                    .toList(growable: false),
              ),
                ...
                children: detail.activities
                    ...
                    .map(
                      (e) => _TimelineTile(
                        ...
                        subtitle: e.value.exposureQuantity != null
